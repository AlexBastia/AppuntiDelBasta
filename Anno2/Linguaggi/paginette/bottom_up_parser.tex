...
Il termine $SLR(1)$ sta per "Single, left-to-right, rightmost derivation” con un simbolo di lookahead
...
\esempio{
    \includegraphics[width=10cm]{esempio_LR(1).png}
}
...
\esempio{
    ...
    \begin{center}
        \includegraphics[width=10cm]{giga_automa.png}
    \end{center}
}
...
\esempio{
    ...
    \includegraphics[width=10cm]{parsing_LR(0).png}
...
\begin{center}
    \includegraphics[width=10cm]{inclusione_tra_grammatiche.png}
\end{center}
...
\esempio{
    \begin{center}
        \includegraphics[width=10cm]{esempio_linguaggio.png}
    \end{center}
}
...
\begin{center}
    \includegraphics[width=10cm]{classificazione_dei_linguaggi.png}
\end{center}
\nt{
...
\esempio{
    ...
    \]
    \begin{center}
        \includegraphics[width=10cm]{automa_bellino.png}
    \end{center}
