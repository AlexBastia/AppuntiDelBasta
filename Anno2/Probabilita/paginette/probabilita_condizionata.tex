...
Ci sono delle situazioni nelle quali puo' esserci richiesto di calcolare la probabilita' condizionata "inversa" conoscendo quella diretta. Possiamo vare cio' usando la definizione di probabilita' condizionate
\thm{}{
  Siano $ A,B $ due eventi t.c. $ P(A), P(B) > 0 $:
  \[
