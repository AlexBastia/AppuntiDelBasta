...
Ogni arco (i, j) ∈ A rappresenta un possibile collegamento; fra di essi
...
Si ha che il valore di $ f $ e' rappresentato \texit{univocamente} dalla quadrupla $(z_1, z_2,y_1,y_2)$, eccetto nel punto di non continuita' $a_2$ che può essere espresso con le due seguenti quadruple:
\[
