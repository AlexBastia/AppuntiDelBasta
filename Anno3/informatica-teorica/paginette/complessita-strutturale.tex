...
\pf{Dimostrazione}{
  Allo stesso modo di SAT, 3SAT appartiene a NP. Dobbiamo dimostrare che e' NP-Hard, che facciamo dimostrando $ SAT \leq_P 3SAT $. Possiamo fare cio' usando una funzione abbastanza ez che a ogni passaggio riesce a diminuire di 1 la lunghezza delle clausole troppo lunghe, quindi dopo un numero finito di riduzioni riusciamo a dimostrare la riduzione iniziale (usando la prop. transitiva).
}
