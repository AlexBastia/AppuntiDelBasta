...
Il prof non va cosi' in dettaglio per il metodo usato nella dimostrazione (dato che e' solo un esempio introduttivo), ma secondo me e' interessante e fornisce un bell'esempio per l'utilita' della Teoria delle Categorie. \textbf{Non ci sara' all'esame sta roba sono solo cazzate mie!!}

\subsubsection{Il Metodo Diagonale}
...
\subsubsection{Dimostrazione Halting Problem}
