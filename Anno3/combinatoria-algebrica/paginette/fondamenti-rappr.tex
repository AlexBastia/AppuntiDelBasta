...
\dfn{Spazio vettoriale libero}{
  Dati due spazi vettoriali $V$ e $U$ su $K$, si definisce spazio vettoriale libero $L(V, U)$ come l'insieme di tutte le funzioni $V \to U$ con operazioni per coordinate.
  \[
  L(V, U) := \{ f: V \to U \mid f \text{ è una funzione lineare} \}
  \]
}
