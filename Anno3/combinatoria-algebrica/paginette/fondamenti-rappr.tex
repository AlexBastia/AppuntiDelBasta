...
\mprop{}{
  Dati due spazi vettroiale $U,V$ su \mathbb{K}, sappiamo costruire uno sp. vett. detto $V \oplus U$:

  E $V \times U$ come le operzioni per coordinata. e se $\{v_i, i \in I\}$ e $\{v_j, j\in J\}$ sono le basi per $V, U$, una base di $U\oplus V$ è $\{v_i, \in I\{U\}u_j\}$
}
