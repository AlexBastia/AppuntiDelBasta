...
\\
\textbf{Costruzione}: Sia $(\rho, V)$ una rappresentazione di un gruppo finito $G$ su uno spazio vettoriale complesso $V$. Dato un prodotto hermitiano arbitrario $( \cdot, \cdot )$ su $V$, definiamo:
...
\textbf{Osservazione fondamentale}. Le seguenti condizioni sono equivalenti:
1. $V$ è una rappresentazione di $G$ (cioè esiste $\rho: G \to \mathrm{GL}(V)$).
