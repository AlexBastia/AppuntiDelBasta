...
\begin{align*}
\mathbb{C}[G] \cong \frac{\mathbb{C}[X]}{(x - 1) \cdot (x + 1) \cdot (x - i) \cdot (x + i)} &\cong \frac{\mathbb{C}[X]}{(x - 1)} \oplus \frac{\mathbb{C}[X]}{(x + 1)} \oplus \frac{\mathbb{C}[X]}{(x - i)} \oplus \frac{\mathbb{C}[X]}{(x + i)} \\
&\cong \mathbb{C} \oplus \mathbb{C} \oplus \mathbb{C} \oplus \mathbb{C} \cong \mathbb{C}^4
\end{align*}\\
