...
\dfn{Sapzio di Hom}{
  ...
  \begin{equation*}
  \mathrm{Hom}_K(V, U) := \{f : V \to U \mid f \text{ lineare}\} \qquad \mathrm{Hom}_K(V,U):={f:V\to U, f\text{ lineare}}
  \end{equation*}
...
\subsection{Operazioni sulle rappresentazione}
...
\subsubsection{Somma diretta di rappresentazioni}



\subsubsection{Prodotto tensoriale di rappresentazioni}


\subsubsection{Spazio duale di una rappresentazione}


\subsubsection{Spazio Hom di rappresentazioni}
