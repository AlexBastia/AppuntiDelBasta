...
\pf{Dimostrazione TODO: DIMOSTRARE OERPER BENE PERCHÉ IL PROF L'HA FATTA MALE ZIO PERA }{
...
TODO: Rappresentazioni come K[G]-Moduli
...
\pf{Dimostrazione}{
  \begin{itemize}
    \item Verifica che $p^G$ è ancora un proiettore su $U$ TODO
    \item Verifica che $p^G$ è $G$-invariante. TODO
  \end{itemize}
}
