...
\thm{Formula del gradiente}{
  ...
  \]
  \[
    \frac{\partial f}{\partial v}(\overline{x}, \overline{y}) = <\nabla f(\overline{x}, \overline{y}), (v_1,v_2)>
  \]
}
\nt{
  Lineare in $ v_1,v_2 $ con coefficenti $ \partial_xf, \partial_yf $, quindi tutte le $ \partial_vf $ si scrivono conoscendo solo $ \partial_xf $ e $ \partial_yf $.
}
